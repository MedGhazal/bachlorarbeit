...
\begin{document}
	...
	Bullet is free for both educational and professional use and compatible with most platforms, Linux/Win32/ Mac\cite{boeing2007evaluation}, and can be described as very portable across devices and operating systems.\newline
