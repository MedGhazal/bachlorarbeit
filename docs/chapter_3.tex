		...
		\subsection{Motion labeling}
			...
			\ForEach{word and position in position\_word}{
				\If{position is verb}{
					...
					\lIf{word in verb\_frequency}{ inkrement verb\_frequency[stem]}
